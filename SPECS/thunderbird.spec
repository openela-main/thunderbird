...
%if %{with langpacks}
Source1: thunderbird-langpacks-%{version}%{?pre_version}-20250819.tar.xz
%endif
...
Provides: bundled(crate(mail-builder)) = 0.3.1
...
%changelog
* Tue Aug 26 2025 Release Engineering <releng@openela.org> - 128.14.0
